...
to setup
  ...
  draw_boundaries
  reset-ticks
  place_malicious_entities
  place_mines
  place_searchers
  ask patches [set scent 0]
  malicious_scent_release
...
to go_exp
  ...
  set new_file_name (word "Searchers_" number_of_searchers "__Mines_" mine_starting_amount "_" date ".csv")
  ...
  [
    ...
    file-print " "
    file-print " "
    file-print "No of Searchers , Ave time to clear , Freezes , Sticks , Too Many Sticks "
...
to mine_check
  ...
  ask searchers
  [
    if ((any? mines-here) AND (current_state != 3)) ; i.e. not suspected malicious activity and not moving away
    [
...
to place_malicious_entities
    ...
    let malicious_count 0
      ...
      set malicious_x_points [25 75 25 75]
      set malicious_y_points [25 25 75 75]

...
to go_exp
  ...
  let stuck_count 0
  let initial_number_of_searchers 10
  ...
  [
    ...
    while [number_of_searchers < 101]
      [
        set new_file_name (word "BASIC_Baseline_Searchers_" number_of_searchers "__Mines_" mine_starting_amount "_" date ".csv")
...
to move_searchers
  ...
  [
    ...
    [
      ...
      ifelse (x_coordinate_reached = TRUE) [move_y_direction] [move_x_direction]
    ]
  ]
